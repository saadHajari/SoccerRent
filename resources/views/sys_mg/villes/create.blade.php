    ...
    <div class="container">
        ...
        <div class="row">
            <div class="card col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2 card-mt-15">
                <h4 class="center grey-text text-darken-2 card-title">Add Ville</h4>
                    ...
                    <div class="row">
                        ...
                        <form action="{{route('villes.store')}}" method="POST">
                            ...
                            <i class="material-icons prefix">account_balance</i>
                                <!--
                                    in value attribute of ville_name input,
                                    we are just using ternary operator and checking 
                                    if it has a value that we have submitted
                                    previously, else set value to ''.
                                -->
                                <input type="text" name="ville_name" id="ville_name" class="validate" value="{{ Request::old('ville_name') ? : '' }}">
