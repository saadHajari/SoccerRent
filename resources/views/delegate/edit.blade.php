    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                <div>
                <h4 class="center grey-text text-darken-2 card-title">Update Delegate</h4>
                </div>
                <hr>
                    ...
                    <form action="{{route('delegates.update',$delegate->id)}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                ...
                                <input type="text" name="Prenom" id="Prenom" value="{{Request::old('Prenom') ? : $delegate->Prenom }}">
                                <label for="Prenom">First Name</label>
                                <span class="{{$errors->has('Prenom') ? 'helper-text red-text' : ''}}">{{$errors->first('Prenom')}}</span>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">person_outline</i>
                                <input type="text" name="Nom" id="Nom" value="{{Request::old('Nom') ? : $delegate->Nom }}">
                                <label for="Nom">Last Name</label>
                                <span class="{{$errors->has('Prenom') ? 'helper-text red-text' : ''}}">{{$errors->first('Prenom')}}</span>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">person</i>
                                <input type="text" name="username" id="username" value="{{Request::old('username') ? : $delegate->username }}">
                            ...
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 offset-l2 xl8 offset-xl2">
                                ...
                                <input type="email" name="email" id="email" value="{{Request::old('email') ? : $delegate->email }}">
                            ...
                            <div class="file-field input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" value="{{old('picture') ? : $delegate->picture }}">
